...
export default function QuadrantMatrix({ quadrant, scoreAdaptation, scoreInteret }: QuadrantMatrixProps) {
  ...
  // X axis = Adaptation (left = low, right = high)
  // Y axis = Intérêt (top = high, bottom = low)
  const cells = [
    { id: 2, position: "top-left" },
